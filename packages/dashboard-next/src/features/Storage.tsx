...
export function StoragePage() {
  ...
  return (
    <div className="space-y-5">
      <PageHeader icon={<HardDrive className="size-5" />} title={t.nav.storage} description="Block devices, mounts and pools." />
      ...
      <Card className="elev-1">
        ...
        <CardContent>
          <DataTable columns={driveCols} initialSort="name" server={{ queryKey: ["drives"], fetch: api.drivesList, refetchInterval: 5000 }} />
        </CardContent>
      </Card>
    </div>
  );
