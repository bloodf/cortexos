  ...
  const columns: Column<IncusInstance>[] = [
    ...
    },
    {
      ...
      cell: (r) =>
        r.project.repo_url ? (
          <a
            href={r.project.repo_url}
            className="text-xs text-primary inline-flex items-center gap-1 hover:underline"
            target="_blank"
            rel="noreferrer"
          >
            {r.project.repo_url.replace("https://", "")}@{r.project.branch}{" "}
    ...
    },
    {
      ...
      header: "RAM",
      sort: (r) => r.memory,
      cell: (r) => <span className="tabular-nums">{r.memory} MiB</span>,
    },
    {
      key: "status",
      header: "Status",
          ...
          actions={[
            {
              ...
              onSelect: () => toast.success(`Started ${r.name}`),
            },
            {
              key: "stop",
              label: "Stop",
              ...
              onSelect: () => toast.success(`Stopped ${r.name}`),
            },
            {
              key: "delete",
              label: "Delete",
