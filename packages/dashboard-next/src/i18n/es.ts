...
export const es: Dict = {
  ...
  overview: {
    ...
    widgets: {
      ...
      servicesOffline: "Caídos",
      servicesIdle: "Inactivos",
      live: "Rendimiento en vivo",
      topProcesses: "Procesos top",
      network: "Red",
      download: "Bajada total",
      upload: "Subida total",
      dbOps: "Ops Bases de datos",
      monOps: "Ops Monitoreo",
      containerOps: "Ops Contenedores",
      docker: "Docker",
      uptime: "Uptime",
  ...
  palette: {
    ...
    services: "Servicios",
    actions: "Acciones",
    hints: { move: "↑↓ mover", select: "↵ elegir", close: "esc cerrar" },
    recent: "Reciente",
  },
