...
import {
  ...
  BadgeCheck, FileKey, Users, Clock, Database,
} from "lucide-react";

export type NavKey =
  | "overview" | "apps" | "healthcheck" | "agents" | "docker" | "incus"
  | "systemd" | "storage" | "network" | "processes" | "terminal" | "mail"
  | "alerts" | "approvals" | "audit" | "services" | "badges" | "env"
  | "users" | "projects" | "account" | "scheduler" | "backups";
