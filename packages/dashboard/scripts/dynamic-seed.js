...
const SPOKE_TO_SERVICES = {
  ...
  "16-mongodb": ["mongodb", "mongo-exporter", "mongo-express"],
  "16a-mysql": ["mysql", "mysql-exporter", "phpmyadmin"],
  "17-dnsmasq": ["dnsmasq"],
...
const ALWAYS_ACTIVE = ["cortex-dashboard", "incus", "watchtower", "hermes-dashboard"];
