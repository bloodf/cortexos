...
export async function finishDashboardCommand(
	...
	if (completion.stdoutSha256 !== undefined)
		setFields.stdoutSha256 = completion.stdoutSha256;
	if (completion.stderrSha256 !== undefined)
		setFields.stderrSha256 = completion.stderrSha256;
	...
	if (completion.journaldCursor !== undefined)
		setFields.journaldCursor = completion.journaldCursor;
