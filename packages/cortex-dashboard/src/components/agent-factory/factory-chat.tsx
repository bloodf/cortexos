...
export function FactoryChat({ factories }: Props) {
	...
	function openFactory(factory: FactorySummary) { setSelected(factory); setDraft(factory); setDefinitionText(JSON.stringify(factory.definition ?? {}, null, 2)); setSaveError(null); }
	function openNewFactory() { const factory = emptyFactory(); setSelected(factory); setDraft(factory); setDefinitionText("{}"); setSaveError(null); }
