...
const MODELS = ["anthropic/claude-sonnet-4", "openai/gpt-4.1", "google/gemini-2.5-pro"];
...
export function FactoryChat({ factories }: Props) {
	const [modelId, setModelId] = React.useState(MODELS[0]);
