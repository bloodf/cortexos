import { 
	...
	SensorCpuGaugeWidget,
	SensorThermalGaugeWidget,
	SensorFanGaugeWidget,
	SensorVoltageGaugeWidget,
	StorageGaugeWidget,
	ServiceOnlineWidget,
...
export const WIDGET_REGISTRY: Record<string, React.FC> = {
	...
	"sensor-cpu-gauge": SensorCpuGaugeWidget,
	"sensor-thermal-gauge": SensorThermalGaugeWidget,
	"sensor-fan-gauge": SensorFanGaugeWidget,
	"sensor-voltage-gauge": SensorVoltageGaugeWidget,
...
export const WIDGET_LABELS: Record<string, string> = {
	...
	"sensor-cpu-gauge": "CPU Sensors",
	"sensor-thermal-gauge": "Thermals",
	"sensor-fan-gauge": "Fans",
	"sensor-voltage-gauge": "Voltage Rails",
