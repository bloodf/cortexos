...
export function MailGuardianReviewsPanel() {
	...
	return (
		<div className="space-y-3">
			...
			{rows.length === 0 ? <EmptyState title="No mail reviews" description={openOnly ? "No open reviews are waiting." : "No reviews recorded."} /> : <DataTable columns={columns} data={rows} noPagination />}
		</div>
	);
}
