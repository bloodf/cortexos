...
export default async function AgentFactoryPage() {
	...
	return <div className="space-y-4"><div><h1 className="text-2xl font-semibold">Agent Factory</h1><p className="mt-1 text-sm text-muted-foreground">Create Paperclip-aligned project factories, seats, positions, and Hermes profiles through 9Router.</p></div><FactoryChat factories={safe} /></div>;
}
