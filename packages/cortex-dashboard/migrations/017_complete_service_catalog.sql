...
BEGIN
  ...
  UPDATE services SET open_url = normalized || ':3000/' WHERE slug = 'grafana';
  UPDATE services SET open_url = normalized || ':9090/' WHERE slug = 'prometheus';
  UPDATE services SET open_url = normalized || ':8081/' WHERE slug = 'cadvisor';
  ...
  UPDATE services SET open_url = normalized || ':8083/' WHERE slug = 'mongo-express';
  UPDATE services SET open_url = normalized || ':8082/' WHERE slug = 'phpmyadmin';
  UPDATE services SET open_url = normalized || ':5540/' WHERE slug = 'redisinsight';
  UPDATE services SET open_url = normalized || ':3001/' WHERE slug = 'langfuse';
