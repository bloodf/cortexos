...
Owns a second parallel backend/API implementation lane for Laravel, PHP, PostgreSQL, Redis, migrations, queues, REST endpoints, and data contracts under STAFF-BACKEND.
