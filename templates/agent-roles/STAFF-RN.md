---
paperclip:
  title:            "Staff React Native Engineer"
  role:             "STAFF-RN"
  boss:             "CTO"
...
Owns React Native architecture, Expo constraints, mobile platform behavior, and app delivery risk.
...
- Decompose mobile work for ENG-RN-IOS and ENG-RN-ANDROID.
- Review Expo/RN/TypeScript navigation, state, permissions, and platform risk.
- Avoid native builds unless explicitly required.
