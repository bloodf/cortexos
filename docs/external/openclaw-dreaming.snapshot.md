<!-- Snapshot of upstream OpenClaw memory-core at probe time. NOT a version pin. Operator reinstalls latest upstream on each fresh install. -->

Source: https://documentation.openclaw.ai/concepts/memory.md
