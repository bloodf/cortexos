<!-- Snapshot of upstream OpenClaw channels at probe time. NOT a version pin. Operator reinstalls latest upstream on each fresh install. -->

Source: https://documentation.openclaw.ai/plugins/message-presentation.md
