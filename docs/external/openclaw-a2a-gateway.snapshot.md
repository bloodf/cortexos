<!-- Snapshot of upstream openclaw-a2a-gateway at probe time. NOT a version pin. Operator reinstalls latest upstream on each fresh install. -->

Source: https://raw.githubusercontent.com/win4r/openclaw-a2a-gateway/master/README.md
